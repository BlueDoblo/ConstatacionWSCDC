...
public class OpcionalTipoResponse  implements java.io.Serializable {
    private ar.gob.afip.servicios1.wscdc.OpcionalTipo[] resultGet;
    ...
    public OpcionalTipoResponse(
           ar.gob.afip.servicios1.wscdc.OpcionalTipo[] resultGet,
     ...
     * @return resultGet
     */
    public ar.gob.afip.servicios1.wscdc.OpcionalTipo[] getResultGet() {
        return resultGet;
    }
     ...
     * @param resultGet
     */
    public void setResultGet(ar.gob.afip.servicios1.wscdc.OpcionalTipo[] resultGet) {
        this.resultGet = resultGet;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "OpcionalTipoResponse"));
